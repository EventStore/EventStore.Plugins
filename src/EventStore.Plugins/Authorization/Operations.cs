...
public static class Operations {
    ...
    public static class Streams {
        ...
        public static class Parameters {
            public static Parameter StreamId(string streamId) {
                return new("streamId", streamId);
            }

            public static Parameter TransactionId(long transactionId) {
                return new("transactionId", transactionId.ToString("D"));
            }
        }
    }
    ...
    public static class Subscriptions {
        ...
        public static class Parameters {
            public static Parameter SubscriptionId(string id) {
    ...
    public static class Users {
        ...
        public static class Parameters {
            ...
            public static Parameter User(string userId) {
                return new(UserParameterName, userId);
            }
        }
    }
