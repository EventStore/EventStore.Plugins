...
namespace EventStore.Plugins.Authentication {
	public interface IAuthenticationProvider {
		...
		/// <summary>
		/// Authenticate an AuthenticationRequest. Call the appropriate method on <see cref="AuthenticationRequest"/> depending on whether the request succeeded, failed, or errored.
		/// </summary>
